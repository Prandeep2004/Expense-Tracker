...
setBudgetButton.addEventListener('click', () => {
  const budget = parseInt(monthlyBudgetInput.value.trim());
  if (budget) {
        ...
        <div class="expense-details">
          <div class="expense-info">
            ...
            <div class="expense-meta">
              ...
              <span><i class="fas fa-dollar-sign"></i> ${expense.amount}</span>
...
saveExpenseButton.addEventListener('click', () => {
  ...
  const amount = parseInt(editExpenseAmount.value.trim());
